...
const Sidebar: React.FC = () => {
  ...
  const isActive = location.pathname === "/trainee/courses";
      ...
      <nav className="mt-3">
        <ul>
          ...
          >
            ...
            <li>
              <Link to="/trainee/courses">Enrolled Courses</Link>
            </li>
          </div>
          ...
          <div className="flex flex-col-2 py-3 px-4 rounded-lg hover:bg-violet-500 transition text-slate-600 bg-white mb-5 hover:text-white gap-4">
            ...
            <li>
              <Link to="/trainee/code-challenges"> Code Challenges</Link>
            </li>
          </div>
          ...
          <div className="flex flex-col-2 py-3 px-4 rounded-lg hover:bg-violet-500 transition text-slate-600 bg-white mb-5 hover:text-white gap-4">
            ...
            <li>
              <Link to="/trainee/settings">User Settings</Link>
            </li>
          </div>
        </ul>
      </nav>
